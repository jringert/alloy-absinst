...
public class CycleViz {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        PrintWriter out = new PrintWriter(System.getProperty("user.dir") + "/src/test/inst/cycle.xml", "UTF-8");
        ...
        VizGUI viz = new VizGUI(false, System.getProperty("user.dir") + "/src/test/inst/cycle.xml", null);
    }
}
